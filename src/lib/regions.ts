export const REGION_MAPPINGS: Record<string, Record<string, string>> = {
  ...
  'GB': {
    'KENT': 'KEN', 'ESSEX': 'ESS', 'SURREY': 'SRY', 'HAMPSHIRE': 'HAM', 'HERTFORDSHIRE': 'HRT',
    'LANCASHIRE': 'LAN', 'NORFOLK': 'NFK', 'NORTH YORKSHIRE': 'NYK', 'STAFFORDSHIRE': 'STS',
    'SUFFOLK': 'SFK', 'SUSSEX': 'SSX', 'WEST SUSSEX': 'WSX', 'EAST SUSSEX': 'ESX',
    'LINCOLNSHIRE': 'LIN', 'DEVON': 'DEV', 'DORSET': 'DOR', 'CHESHIRE': 'CHS',
    'GLOUCESTERSHIRE': 'GLS', 'CORNWALL': 'CON', 'CAMBRIDGESHIRE': 'CAM',
    'BERKSHIRE': 'BRK', 'BUCKINGHAMSHIRE': 'BKM', 'OXFORDSHIRE': 'OXF',
    'NORTHAMPTONSHIRE': 'NTH', 'SHROPSHIRE': 'SHR', 'SOMERSET': 'SOM',
    'WILTSHIRE': 'WIL', 'WORCESTERSHIRE': 'WOR', 'WARWICKSHIRE': 'WAR',
    'LEICESTERSHIRE': 'LEI', 'NOTTINGHAMSHIRE': 'NTT', 'DERBYSHIRE': 'DBY'
  }
};
